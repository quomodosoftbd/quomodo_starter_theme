                ...
                <div class="qs__post__comment__meta"><!-- .qs__post__comment__meta -->
                    <div class="qs__post__comment__author qs__post__comment__vcard"><!-- .qs__post__comment__author -->
                        ...
                        printf(
                            ...
                            wp_kses(
                                __( '%s <span class="screen-reader-text says">says:</span>', 'quomodo_starter_theme_prefix' ),
                                array(
                                    'span' => array(
                                        'class' => array(),
                                    ),
                    ...
                    <div class="qs__post__comment__metadata">
                        ...
                        <?php
                            $edit_comment_icon = 'icon';
                            edit_comment_link( __( 'Edit', 'quomodo_starter_theme_prefix' ), '<span class="qs__post__comment__edit__link__sep">&mdash;</span> <span class="qs__post__comment__edit__link">' . $edit_comment_icon, '</span>' );
                        ?>
                    </div><!-- .qs__post__comment__metadata -->
 
                    <?php if ( '0' == $comment->comment_approved ) : ?>
                        <p class="qs__post__comment__awaiting__moderation"><?php esc_html__e( 'Your comment is awaiting moderation.', 'quomodo_starter_theme_prefix' ); ?></p>
                    <?php endif; ?>
