...
if ( ! function_exists( 'quomodo_starter_theme_prefix_setup' ) ) :
	...
	function quomodo_starter_theme_prefix_setup() {
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'quomodo_starter_theme_prefix' ),
			)
		);
...
function quomodo_starter_theme_prefix_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'quomodo_starter_theme_prefix' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'quomodo_starter_theme_prefix' ),
